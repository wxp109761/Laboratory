...
public class TextAdapter extends ArrayAdapter<String> {
	...
	private List<String> mListLabId;
	...
	public TextAdapter(Context context, List<String> listData,int sId, int nId,String cate) {
	...
	public TextAdapter(Context context, List<String> listData, List<String> ListLabId, int sId, int nId) {
		super(context, R.string.no_data, listData);
		mContext = context;
		mListData = listData;
		mListLabId=ListLabId;
		selectedDrawble = mContext.getResources().getDrawable(sId);
		normalDrawbleId = nId;
		init();
	}
	...
	public void setSelectedPosition(int pos) {
		if (mListData != null && pos < mListData.size()) {
			...
			if(cates.equals("0")){
				selectedLabId = mListLabId.get(pos);
			}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mListData != null) {
			if (position < mListData.size()) {
				...
				if(cates.equals("0")){
					mLaIdString=mListLabId.get(position);
				}
		...
		if(cates.equals("0")){
			if (selectedText != null && selectedLabId.equals(mLaIdString)) {
